package com.jiketuandui.antinetfraud.View.myRecyclerView;
 ...
 */
class MyWrapAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public RecyclerView.Adapter adapter;
    private ArrayList<View> headerViews = new ArrayList<>();
    private ArrayList<View> footViews = new ArrayList<>();

    MyWrapAdapter(RecyclerView.Adapter adapter, ArrayList<View> headerViews, ArrayList<View> footViews) {
